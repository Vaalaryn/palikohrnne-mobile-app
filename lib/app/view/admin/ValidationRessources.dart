...
import 'SingleValidation.dart';

class ValidationRessources extends StatefulWidget {
  createState() => ValidationRessourcesState();
}

class ValidationRessourcesState extends State<ValidationRessources> {
  List item = [];
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context2, int index){
          ...
          return ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => SingleValidation(item[index]["ID"].toString())));
              });
        },
      ),
    );
